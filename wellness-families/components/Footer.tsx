          ...
          <div className="space-y-5 sm:space-y-7 max-w-2xl">
            ...
            <div className="flex justify-center space-x-6">
              <a
                ...
                className="text-white/70 hover:text-[#6bb8ff] transition-colors"
                target="_blank"
              ...
              <a href="https://www.instagram.com/wellnessheavensk/" className="text-white/70 hover:text-[#6bb8ff] transition-colors" target="_blank" rel="noopener noreferrer">
