    ...
    <div className="pt-20 sm:pt-24 lg:pt-32 pb-16 sm:pb-20 md:pb-24 lg:pb-32 bg-[#faf9f7] min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-[#c97d60] italic font-display">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-10 border border-[#e8e6e3]">
          ...
          <div className="flex justify-center space-x-6 sm:space-x-8">
            <a href="#" className="text-[#6b6b6b] hover:text-[#c97d60] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center touch-manipulation">
