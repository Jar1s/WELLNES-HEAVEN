...
export const metadata: Metadata = {
  ...
  description: 'Kontaktujte nás na adrese Tomášikova 26, 821 01 Bratislava alebo na telefónnom čísle +421 952 594 495. Otváracie hodiny: Po-Pi 11:00-22:00, So-Ne 10:00-22:00.',
};
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10 md:p-12 border border-[#e8e6e3] text-center space-y-3">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <a href="tel:+421952594495" className="text-[#6bb8ff] hover:text-[#4d9be0] transition-colors font-medium text-sm sm:text-base">
                  +421 952 594 495
                </a>
              </div>
            </div>
